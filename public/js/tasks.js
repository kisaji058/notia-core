...
const PLAN_TYPE_ICONS = {
  task: "/images/nav/task-selected.png",
  event: "/images/nav/point-selected.png",
  routine: "/images/nav/routine-icon-concept.png",
};

function getPlanTypeLabelHtml(type, label) {
  const src = PLAN_TYPE_ICONS[type];
